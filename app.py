...
from flask_cors import CORS                 #para acceder al json
from flask_sqlalchemy import SQLAlchemy     #OMR manejador de base de datos
...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://sql10508116:AwDfcSGdnw@sql10.freemysqlhosting.net/sql10508116'
...
#programos los mapeos, rutas, endpoint, url
